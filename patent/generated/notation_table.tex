...
\caption{Comprehensive notation used in the formal models, algorithms, operational equations, and evaluation.}\label{tab:notation}\\
\toprule
Symbol & Definition \\
\midrule
\endfirsthead
...
$\mathcal{W}_{\mathrm{create}}$ & Result of the controlled generation operation on $S_{\mathrm{eligible}}$. \\
...
$R_{\mathrm{src}}(\mathbf{x})$ & Contribution of the ready candidate, represented as a weighted sum of the evidence coverage vector $\mathbf{x}$. \\
$B_{\mathrm{gen}},P_{\mathrm{gap}}$ & Bonus and penalty for the generated content depending on whether there is evidence or evidence contradiction. \\
...
$p_k,k,K_{\mathrm{arm}}$ & Prompt pack associated with the arm $k$, the arm index, and the number of prompt-policy arms. \\
...
$\ell_t,\ell(t)$ & Confidence gap at attempt $t$ and its continuous interpolation. \\
...
$\Delta_{\mathrm{B3},m},\Delta$ & Mean composite difference between B3 and baseline method $m\in\{\mathrm{B0},\mathrm{B1},\mathrm{B2}\}$, and a generic resampled mean difference. \\
$H_0,H_1,\mu_m$ & Null/alternative hypotheses and mean composite for method $m$. \\
$Q_{\mathrm{omni}}$ & Matched-study permutation omnibus statistic. \\
$H_{\mathrm{KW}},F_{\mathrm{ANOVA}},U_{\mathrm{MW}}$ & Kruskal--Wallis, one-way ANOVA, and Mann--Whitney statistics. \\
$r_{rb},\delta_{\mathrm{Cliff}}$ & Paired rank-biserial and Cliff's effect sizes. \\
$X,Y,x_i,y_j,n_x,n_y,\bar X,\bar Y$ & Two comparison samples, indexed observations, sample sizes, and sample means. \\
$n,\mathrm{SD},\mathrm{IQR},\mathrm{P90}$ & Generic sample size, sample standard deviation, interquartile range, and 90th percentile. \\
$p,p_{\mathrm{Holm}},\alpha_{\mathrm{sig}},M_{\mathrm{cmp}}$ & Raw or reported probability value, Holm-adjusted probability value, familywise significance level, and number of pairwise comparisons. \\
